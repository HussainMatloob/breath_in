...
class SenderVoiceWidget extends StatefulWidget {
  final MessagesModel?  messagesModel;
  const SenderVoiceWidget({super.key, this. messagesModel});

  @override
  State<SenderVoiceWidget> createState() => _SenderVoiceWidgetState();
}

class _SenderVoiceWidgetState extends State<SenderVoiceWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      margin:  EdgeInsets.only( left: 50.0.w,top: 8.h,bottom: 8.h),
