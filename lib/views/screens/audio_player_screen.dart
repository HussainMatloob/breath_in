            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  //   ),
                  // ),
                  Center(child:audioController.isLoading.value?CircularProgressIndicator(color: ColorConstant.buttonColor):Container()),
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              CustomText("${audioController.formatTime(audioController.position.value)}",color: ColorConstant.whiteColor,),
                              CustomText("${audioController. formatTime(audioController.duration.value)}",color: ColorConstant.whiteColor,),
                            ],),
                        ),
                        SizedBox(height: 10.h,),
                        Row(
                          ...
                          children: [
                            ...
                            CustomButton(
                              ...
                              onTap: () async {
                                audioController.pauseOrResume(widget.audioFile!.audioFile!);
                              },
                            ),
                            SizedBox(width: 20.w),
                            // Skip next button
